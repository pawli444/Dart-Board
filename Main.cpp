...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        dartModel = glm::translate(dartModel, glm::vec3(0.0f, 0.0f, 0.026f)); // prawie przy œcianie
        dartModel = glm::scale(dartModel, glm::vec3(scale));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(dartModel));
